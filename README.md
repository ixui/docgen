...
npm install -g https://github.com/ixui/docgen/releases/download/v2.0.7/ixui-docgen-2.0.7.tgz

# Method 2: Download and install manually
wget https://github.com/ixui/docgen/releases/download/v2.0.7/docgen-dist.tar.gz
