...
npm install -g https://github.com/ixui/docgen/releases/download/v2.0.10/ixui-docgen-2.0.10.tgz

# Method 2: Download and install manually
wget https://github.com/ixui/docgen/releases/download/v2.0.10/docgen-dist.tar.gz
...
3. Create and push a git tag: `git tag v2.0.10 && git push origin v2.0.10`
